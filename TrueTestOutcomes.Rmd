...
observeEvent(c(input$simulate, input$alpha, input$beta, input$mde, input$tails, input$base, input$testCt, input$avgE, input$traffVolume, input$cvValue, input$months), {
  a <- 1 - (input$alpha/100)
  b <- input$beta/100 
